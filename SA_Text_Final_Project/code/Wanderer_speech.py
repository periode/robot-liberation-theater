...
our_request = requests.get("http://www.teenhut.net/forums/93-depression-self-harm-and-suicide/?s=b09cc2ca4120f075936788da2731e30ce76fdd71", headers = headers)
print our_request.status_code


parsed_html = bs4.BeautifulSoup(our_request.text, "html.parser")

all_results = parsed_html.find_all(class_="messageGroupLink wbbTopicLink")
...
saved_comments = open("teens.txt", "w")
